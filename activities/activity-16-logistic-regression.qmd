...
subtitle: "Finding emails that are spams"
editor: visual
---
...
-   Would you expect longer or shorter emails to be spam? Create a density plot to investigate the relationship between `spam` and `mean_num_char`
